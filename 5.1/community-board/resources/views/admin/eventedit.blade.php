    ...
    <div id="wrap">
      ...
      <div class="container" style="padding-top: 30px;">
        <div class="page-header">
            ...
            <div class="row">
                <div class="col-md-6"><h1>Edit Event</h1><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui, repellat, quia, hic ipsum cumque minus laborum veritatis facilis itaque ducimus sunt minima aliquid molestias error libero odit consectetur earum sed.</p></div>
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    {{ Form::open(array('action' => 'AdminController@saveEditEvent', 'class' => 'form-horizontal', 'role' => 'form')) }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control help-block" id="location" name="location" value="{{$event->location}}">
                        </div>    
                            ...
                            <div class="col-md-6">
                                <label for="start">Start Date/Time</label>
                                    <div class='input-group date' id='datetimepicker1'>
                                        <input type='text' class="form-control" name="start" id="start" value="{{$event->start}}" data-format="YYYY-MM-DD HH:mm:ss" />
                            ...
                            <div class="col-md-6">
                                <label for="end">End Date/Time</label>
                                    <div class='input-group date' id='datetimepicker2'>
                                        <input type='text' class="form-control" name="end" id="end" value="{{$event->end}}" data-format="YYYY-MM-DD HH:mm:ss" />
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                            </div>                            
                        </div>
