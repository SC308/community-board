                    ...
                    {{ Form::open(array('action' => 'AdminController@saveEditPhoto', 'class' => 'form-horizontal', 'role' => 'form')) }}
                        ...
                        <div class="form-group">  
                            ...
                            <div class="onoffswitch">
                                <input type="checkbox" name="publish" class="onoffswitch-checkbox" id="toggle_{{$photos->id}}" checked>
                                <label class="onoffswitch-label" for="toggle_{{$photos->id}}">
                            ...
                            @else
                            <div class="onoffswitch">
                                <input type="checkbox" name="publish" class="onoffswitch-checkbox" id="toggle_{{$photos->id}}">
                                <label class="onoffswitch-label" for="toggle_{{$photos->id}}">
                                    <div class="onoffswitch-inner"></div>
                                    <div class="onoffswitch-switch"></div>
                                </label>
