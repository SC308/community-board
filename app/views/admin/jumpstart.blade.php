...
m     <!-- Fixed navbar -->
      ...
      <div class="container" style="padding-top: 30px;">
        <div class="page-header">
            ...
            <div class="row">
                <div class="col-md-6"><h1>Jumpstart</h1><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui, repellat, quia, hic ipsum cumque minus laborum veritatis facilis itaque ducimus sunt minima aliquid molestias error libero odit consectetur earum sed.</p></div>
