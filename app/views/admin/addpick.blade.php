...
<html lang="en">
  <head>
    ...
    <title><?php echo $storedetails[0]->store_name?> Community Board Admin :: Upload Top Pick</title>
    ...
    <div id="wrap">
      ...
      <div class="container" style="padding-top: 30px;">
        <div class="page-header">
            ...
            <div class="row">
                <div class="col-md-6"><h1>Add Top Pick</h1><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui, repellat, quia, hic ipsum cumque minus laborum veritatis facilis itaque ducimus sunt minima aliquid molestias error libero odit consectetur earum sed.</p></div>
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    {{ Form::open(array('action' => 'AdminController@saveAddPick', 'files' => true, 'class' => 'form-horizontal', 'role' => 'form')) }}
                        <div class="form-group">
                            <label for="pick">Top Pick</label>
                            {{ Form::file('pick') }}
                        </div>
