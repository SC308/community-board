  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="container" style="padding-top: 30px;">
        ...
        <div class="row">
                {{ Form::open(array('action' => 'AdminController@saveStaffAdd', 'files'=>true, 'class' => 'form-horizontal', 'role' => 'form')) }}
                ...
                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control help-block" id="favsport" name="favsport" value="">
                        </div>    
                        <div class="form-group">    
